...
class PlatformControllerIntegrationTest {
    ...
    void marksSidecarsOfflineWhenAttachExecutorLeaseExpires() throws Exception {
        ...
        assertThat(testPlatformMapper.attachExecutorStatus("kairo-expired-executor"))
                .isEqualTo("OFFLINE");
        assertThat(testPlatformMapper.attachExecutorTargetStatus("kairo-expired-executor", instanceId))
                .isEqualTo("OFFLINE");
