...
import { KairoIcon } from "@/components/brand/kairo-icon";
    ...
    <main className="grid min-h-screen lg:grid-cols-[1.15fr_0.85fr]">
      <section className="relative hidden overflow-hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3">
          <KairoIcon className="size-11" />
          <div>
            <div className="font-semibold tracking-tight">Kairo</div>
        ...
        <p className="relative text-xs text-slate-500">Kairo Platform · Independent Web Console</p>
      </section>

      <section className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="mb-10 flex items-center gap-3 lg:hidden">
            <KairoIcon className="size-10" />
          ...
          <div className="mt-7 rounded-xl border border-slate-200 bg-slate-50 p-4 text-xs leading-5 text-slate-500">
            Demo 环境可使用 <code className="rounded bg-white px-1.5 py-0.5 font-mono text-indigo-700">kairo-demo</code>。真实环境请使用管理员签发的 Token。
          </div>
        </div>
      </section>
    </main>
