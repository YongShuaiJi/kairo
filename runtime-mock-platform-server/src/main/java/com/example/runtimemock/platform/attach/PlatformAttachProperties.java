...
@ConfigurationProperties("runtime-mock.platform.attach")
public class PlatformAttachProperties {

    private String agentJar = "/app/runtime-mock-agent-bootstrap.jar";
    private String coreJar = "/app/runtime-mock-agent-core-modern.jar";
    private String bootstrapJar = "/app/runtime-mock-bootstrap-api.jar";
